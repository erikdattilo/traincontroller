...
namespace wx.SampleListCtrl
{
    ...
    public class MyFrame : Frame
    {
            ...
            : base(title, pos, size)
        {
            ...
            Icon = new wx.Icon("../../mondrian.png");

            // Make an image list containing large icons
            m_imageListNormal = new ImageList(32, 32, true);
            m_imageListSmall = new ImageList(16, 16, true);

            Image image = new Image("../../bitmaps/toolbrai.xpm");
            m_imageListNormal.Add(new Bitmap(image));
            
          
          image = new Image("../../bitmaps/toolchar.xpm");
    String[] test_xpm = new String[] {
"7 9 3 1",
"       c #FFFFFFFFFFFF",
".      c #000000000000",
...
//+ "\" ..... \"};" + eol
          ...
          string eol = "\r\n";
    string str = test_xpm.Aggregate((current, next) => current + eol + next) + eol;
    str = ""
      + "/* XPM */" + eol
      + "static char * toolnote_xpm[] = {" + eol
      + str
      + "};" + eol
      ;
    ...
    str = ""
      + "/* XPM */" + eol
      + "static char * toolnote_xpm[] = {" + eol
      + "/* width height ncolors chars_per_pixel */" + eol
      + "\"32 32 8 1\"," + eol
      + "/* colors */" + eol
      + "\" 	s None	c None\"," + eol
      + "\".	c #000000\"," + eol
...
if(false)
    ...
    image = new Image(data, BitmapType.wxBITMAP_TYPE_XPM);
          
          
            m_imageListNormal.Add(new Bitmap(image));
            image = new Image("../../bitmaps/tooldata.xpm");
            m_imageListNormal.Add(new Bitmap(image));
            image = new Image("../../bitmaps/toolnote.xpm");
            m_imageListNormal.Add(new Bitmap(image));
            image = new Image("../../bitmaps/tooltodo.xpm");
            m_imageListNormal.Add(new Bitmap(image));
            image = new Image("../../bitmaps/toolchec.xpm");
            m_imageListNormal.Add(new Bitmap(image));
            image = new Image("../../bitmaps/toolgame.xpm");
            m_imageListNormal.Add(new Bitmap(image));
            image = new Image("../../bitmaps/tooltime.xpm");
            m_imageListNormal.Add(new Bitmap(image));
            image = new Image("../../bitmaps/toolword.xpm");
            m_imageListNormal.Add(new Bitmap(image));

            image = new Image("../../bitmaps/small1.xpm");
    ...
    public class ListCtrlApp : wx.App
    {
        ...
        static void Main()
        {
            ...
            FromPxmStringArrayToFile();
            app.Run();
        }

        public static void FromPxmStringArrayToFile() {
          Test123 t = new Test123();

          foreach(FieldInfo info in t.GetType().GetFields()) {
            if(!"System.String[]".Equals(info.FieldType.FullName))
              continue;
            String name = info.Name;
            String[] value = (String[])info.GetValue(t);
        ...
        public static void SaveFile(String fileName, String[] content) {
          ...
          int i = 0;
          sb.AppendLine("/* XPM */");
          sb.AppendLine("static char * toolnote_xpm[] = {");
          sb.AppendLine("/* width height ncolors chars_per_pixel */");
          sb.AppendFormat("\"{0}\"\r\n", content[i++]);
          // sb.AppendLine("\"32 32 8 1\",");
          sb.AppendLine("/* colors */");
          for(; i < content.Length; i++) {
            bool isLast = (i == content.Length - 1);
            sb.AppendFormat(
              "\"{0}\"{1}\r\n",
              content[i],
              isLast ? ";" : ","
          ...
          using(TextWriter writer = File.CreateText(fileName + ".xpm")) {
            writer.Write(sb);
          }
        }
    }
