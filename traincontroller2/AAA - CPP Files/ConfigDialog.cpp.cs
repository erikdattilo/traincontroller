...
// 
// const wxChar	*languages[] = { wxT("English"), wxT("Espanol"), wxT("Francaise"), wxT("Italiano"), wxT("Magyar"), 0 };
// const wxChar	*locales[] = { wxT(".en"), wxT(".es"), wxT(".fr"), wxT(".it"), wxT(".hu"), 0 };
// 
...
// 	    L("Language to use next timenTraindir is started:"));
//     
