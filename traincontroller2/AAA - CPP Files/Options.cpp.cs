...
// {
//         wxFprintf(fp, wxT("%s = %sn"), _name.c_str(), _sValue.c_str());
//         return false;
// }
// 
// IntOption::IntOption(Char *name, Char *descr, Char *cat, Char *defValue)
// : Option(OPTION_INT, name, descr, cat, defValue)
// {
//         if(defValue)
//             _iValue = myAtoi(defValue);
// }
// 
// IntOption::~IntOption()
// {
...
// }
// 
// BoolOption::BoolOption(Char *name, Char *descr, Char *cat, Char *defValue)
