...
// }
// 
// void	PlatformGraphView::DrawStations(grid *g)
// {
// 	Track	*t;
// 	int	y = HEADER_HEIGHT;
// 
// 	nstations = 0;
// 	for(t = layout; t && nstations < 100; t = t->next) {
// 	    if(!t->isstation || !t->station)
// 		continue;
// 	    stations[nstations++] = t;
// 	    DrawTimeGrid(g, y);
// 	    g->DrawText1(0, y - 10, t->station, 0);
// 	    g->DrawLine(STATION_WIDTH + KM_WIDTH, y,
// 		STATION_WIDTH + KM_WIDTH + 24 * 120, y, 0);
// 	    y += Y_DIST;
// 	}
// 	if(!nstations) {
...
// }
// 
// void	PlatformGraphView::DrawTrains(grid *g)
// {
// 	Train	*t;
// 	TrainStop *ts;
// 	Track	*trk;
...
// 		time_to_time(g, nx, ny, x, y, t->type);
