...
namespace Traincontroller2 {
  ...
  public class GTFS {
    public ManagedArray<GTFS_Agency> _agencies;
    public ManagedArray<GTFS_Stop> _stops;
    public ManagedArray<GTFS_Route> _routes;
    public ManagedArray<GTFS_Trip> _trips;
    public ManagedArray<GTFS_StopTime> _stopTimes;
    public ManagedArray<GTFS_Calendar> _calendar;
    public ManagedArray<GTFS_CalendarDate> _calendarDates;
    public ManagedArray<GTFS_FareAttribute> _fareAttributes;
    public ManagedArray<GTFS_FareRule> _fareRules;
    public ManagedArray<GTFS_Shape> _shapes;
    public ManagedArray<GTFS_Frequency> _frequencies;
    public ManagedArray<GTFS_Transfer> _transfers;
