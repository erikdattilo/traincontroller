...
namespace TrainController {
  ...
  public class MainFrame2 : Frame {
    ...
    private void PrepareMenuBar() {
      ...
      fileMenu.Append((int)wx.MenuIDs.wxID_OPEN, I18N.L("&Open...\tCtrl-O"), I18N.L("Open a simulation file."));
      //      fileMenu.Append(wx.MenuIDs.wxID_SAVE, I18N.L("&Save Game..."), I18N.L("Open a saved simulation file."));
      //      fileMenu.Append(wx.MenuIDs.wxID_REVERT, I18N.L("&Restore..."), I18N.L("Restore from the last saved state."));
      //      fileMenu.AppendSeparator();
      //      fileMenu.Append(MenuIDs.MENU_HTML_PRINTSETUP, I18N.L("Page set&up"), I18N.L("Changes the page layout settings."));
      //      fileMenu.Append(MenuIDs.MENU_HTML_PREVIEW, I18N.L("Pre&view"), I18N.L("Preview print output."));
      //      fileMenu.Append(MenuIDs.MENU_HTML_PRINT, I18N.L("&Print"), I18N.L("Print all or part of the document."));
      fileMenu.AppendSeparator();
      fileMenu.Append((int)wx.MenuIDs.wxID_EXIT, I18N.L("E&xit\tAlt-F4"), I18N.L("Quit this program."));

      Menu editMenu = new Menu();
      //      editMenu.Append(MenuIDs.MENU_EDIT, I18N.L("&Edit\tCtrl-E"), I18N.L("Enter/exit layout editor."));
      //      editMenu.Append(MenuIDs.MENU_ITINERARY, I18N.L("&Itinerary"), I18N.L("Enter/exit itinerary editor."));
      //      editMenu.Append(MenuIDs.MENU_SWITCHBOARD, I18N.L("Switch&board"), I18N.L("Shows the switchboard editor."));
      //      editMenu.Append(MenuIDs.MENU_SAVE_LAYOUT, I18N.L("&Save Layout"), I18N.L("Save changes to the layout."));
      //      editMenu.Append(MenuIDs.MENU_PREFERENCES, I18N.L("&Preferences..."), I18N.L("Change program's preferences."));
      //      editMenu.Append(MenuIDs.MENU_NEW_LAYOUT, I18N.L("Ne&w"), I18N.L("Erase the layout."));
      //      editMenu.Append(MenuIDs.MENU_INFO, I18N.L("In&fo"), I18N.L("Show information about the scenario."));
      //      editMenu.Append(MenuIDs.MENU_STATIONS_LIST, I18N.L("Stations &List"), I18N.L("Show list of stations and entry points."));

      Menu runMenu = new Menu();
      //      runMenu.Append(MenuIDs.MENU_START, I18N.L("&Start\tCtrl-S"), I18N.L("Start/stop the simulation."));
      //      runMenu.Append(MenuIDs.MENU_GRAPH, I18N.L("&Graph\tCtrl-G"), I18N.L("Show the timetable graph."));
      //      runMenu.Append(MenuIDs.MENU_LATEGRAPH, I18N.L("&Late Graph\tCtrl-I18N.L"), I18N.L("Show accumulation of late minutes over time."));
      //      runMenu.Append(MenuIDs.MENU_PLATFORMGRAPH, I18N.L("&Platform Graph"), I18N.L("Show platforms occupancy over time."));
      //      runMenu.Append(MenuIDs.MENU_RESTART, I18N.L("&Restart..."), I18N.L("Restart the simulation."));
      //      runMenu.Append(MenuIDs.MENU_FAST, I18N.L("&Fast\tCtrl-X"), I18N.L("Speed up the simulation."));
      //      runMenu.Append(MenuIDs.MENU_SLOW, I18N.L("&Slow\tCtrl-Z"), I18N.L("Slow down the simulation."));
      //      runMenu.Append(MenuIDs.MENU_SKIP, I18N.L("S&kip ahead\tCtrl-K"), I18N.L("Skip to 3 minutes before next evt."));
      //      runMenu.Append(MenuIDs.MENU_STATION_SCHED, I18N.L("S&tation schedule\tF6"), I18N.L("Show the train schedule of each station."));
      //      runMenu.Append(MenuIDs.MENU_SETGREEN, I18N.L("Set sig. to green"), I18N.L("Set all automatic signals to green."));
      //      runMenu.Append(MenuIDs.MENU_SELECT_ITIN, I18N.L("Select Itinerary\tCtrl-I"), I18N.L("Select an itinerary by name."));
      //      runMenu.Append(MenuIDs.MENU_PERFORMANCE, I18N.L("&Performance"), I18N.L("Show performance data."));

      // m_viewMenu = new Menu();
      //      m_viewMenu.Append(MenuIDs.MENU_SHOW_LAYOUT, I18N.L("Show layout\tF3"), I18N.L("Forcibly show the layout window."));
      //      m_viewMenu.Append(MenuIDs.MENU_SHOW_SCHEDULE, I18N.L("Show schedule\tF4"), I18N.L("Forcibly show the schedule window."));
      //      m_viewMenu.Append(MenuIDs.MENU_INFO_PAGE, I18N.L("Show info page\tF5"), I18N.L("Shows the scenario info page, if available."));
      ...
      //      m_viewMenu.Append(MenuIDs.MENU_ZOOMIN, I18N.L("Zoom in"), I18N.L("Draw the layout at double the resolution."));
      //      m_viewMenu.Append(MenuIDs.MENU_ZOOMOUT, I18N.L("Zoom out"), I18N.L("Draw the layour at normal resolution."));
      ...
      //      helpMenu.Append(wx.MenuIDs.wxID_ABOUT, I18N.L("Welcome\tF1"), I18N.L("Show the welcome page."));
      //      helpMenu.Append(MenuIDs.MENU_COPYRIGHT, I18N.L("Copyright"), I18N.L("Show the copyright notice."));
      //      helpMenu.Append(MenuIDs.MENU_LANGUAGE, I18N.L("Language"), I18N.L("Select the language to be used next time Traindir is started."));
...
public void OnSpin(object sender, Event evt)
{
  ...
  public class MainFrame_RIMIOVIMI : Frame {
    public MainFrame_RIMIOVIMI(String title)
      : base(title) { // : base(null, wx.Window.wxID_ANY, title) {
      ...
      //      Canvas pCanvas = new Canvas(m_top);
      //      pCanvas.Name = (wxPorting.T("canvas"));
      //      m_top.AddPage(pCanvas, I18N.L("Layout"), true, -1);
      ...
      //      m_timeTable = m_timeTableManager.GetNewTimeTableView(m_left, I18N.L("Schedule"));
      //      m_itineraryView = new ItineraryView(m_left, I18N.L("Itinerary"));
      //      m_itineraryView.Show(false);
      ...
      //      m_alertList = new AlertList(m_right, I18N.L("Alerts"));
      //      m_trainInfo = new TrainInfoList(m_right, I18N.L("Train Info"));
      ...
      //      m_printer = new HtmlEasyPrinting(I18N.L(""), this);
